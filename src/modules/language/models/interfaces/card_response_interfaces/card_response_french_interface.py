...
class FrenchCardResponse(BaseModel):
    ...
    definition: str = Field(
        ...,
        description="""
            Provide a clear, concise definition of the word suitable for learners in French
            Guidelines:
    ...
    sentence: str = Field(
        ...,
        description="""
            A single example sentence showing how the word is used in context for the French language
            Guidelines:
